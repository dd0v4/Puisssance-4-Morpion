...
//Fonction pour détecter si l'un des deux user a gagné horizontalement et verticalement au puissance4
...
// Genere un tableau HTML utilisable pour nos jeux
...
morpion.addEventListener("click", (e) => {
    ...
    // demande à l'user si il veut jouer contre l'ordinateur ou contre un humain
        ...
        document.querySelectorAll(".case").forEach(div => {
            div.addEventListener("click", (event) => {
                ...
                if (turn1){
                    ...
                    // Si c'est le tour de l'user 1, mettre un cercle et vérifier si l'user a choisi de jouer contre l'ordinateur pour cliquer au hasard
                }else if(turn2){
                    if (event.currentTarget.id != "croix" && event.currentTarget.id != "cerclemp"){
                    ...
                    // Si c'est le tour de l'user 2, mettre une croix
                }
                ...
                // Contrôler si un des deux user a gagné verticalement
                ...
                rows.forEach(row => {
                 ...
                 // Contrôler si un des deux user a gagné horizontalement
                ...
                rows.forEach(row => {
                 ...
                 // Contrôler si un des deux user a gagné diagonalement
            })
...
puissance4.addEventListener("click", (e) => {
    ...
    // Demande à l'user si il veut jouer contre l'ordi ou un humain
    ...
    if (isP4) {
        document.querySelectorAll(".cercle").forEach(div => {
            div.addEventListener("click", (event) => {
                ...
                if (vide) {
                    ...
                    if (turn1) {
                        ...
                        if(vsOrdi){
                            ...
                            firstChildColonne.click()
                            // Si l'user a choisi de jouer contre l'ordi, clique aléatoirement
                ...
                // Check si les cases sous la case cliquée sont vides pour gérer la gravité et met une couleur red ou yellow au cercle selon le tour de l'user

                gagner(colIndex, rowIndex);
                //utilisation de notre fonction pour le contrôle horizontal et vertical
                ...
                // contrôle si l'user gagne sur les diagonales allant vers la gauche
                ...
                // contrôle si l'user gagne sur les diagonales allant vers la droite
